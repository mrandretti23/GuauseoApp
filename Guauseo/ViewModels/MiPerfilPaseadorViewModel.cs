...
{
    public partial class MiPerfilPaseadorViewModel:ObservableObject
    {
        ...
        public MiPerfilPaseadorViewModel()
        {

        }
        public MiPerfilPaseadorViewModel(decimal usuario, INavigation navigation)
        {
        ...
        {
            var usuario = await _dbContext.Paseadores.FirstOrDefaultAsync(u => u.Codigo == Codigo);
            if (usuario != null)
            {
        ...
        {
            var u = await _dbContext.Paseadores.FirstOrDefaultAsync(u => u.Codigo == Codigo);
        ...
        private async Task DeleteProfile()
        {
            ...
            try
            {
                ...
                if (usuario != null)
                {
                    _dbContext.Paseadores.Remove(usuario);
                    await _dbContext.SaveChangesAsync();
